...
class Lionite_Paypal {
	...
	protected $_settings = array (
		'live' => array (
			'username' => 'jeremy_api1.jeremylancasterconsulting.com',
			'password' => '5Q3C4V5ZSP6PQE72',
			'signature' => 'AFcWxV21C7fd0v3bYYYRCpSSRl31AyHyZdOrJ1LYSlH5LfjS9FlVW3q8',
	...
	public function getRecurringProfile($profileId,$paramFormat = true) {
		...
		if(is_array($result) && $paramFormat) {
			$mainKeys = array('profile_id' => 'PROFILEID','status' => 'STATUS');
			$minorKeys = array(
				'num_cycles_completed' => 'NUMCYCLESCOMPLETED','num_cycles_remaining' => 'NUMCYCLESREMAINING',
				'outstanding_balance' => 'OUTSTANDINGBALANCE','failed_payments' => 'FAILEDPAYMENTSCOUNT',
				'last_payment_date' => 'LASTPAYMENTDATE','last_payment_amount' => 'LASTPAYMENTAMT',
				'final_payment_date' => 'FINALPAYMENTDUEDATE',
			);
			$reformat = $mainKeys + $this -> _recurringPaymentsOptions + $minorKeys;
